...
<div class="card custom-card">
    <div class="card-header">
        ...
        <a href="<?= base_url("/c/" . $cliente['slug']) ?>" class="btn btn-link" target="_blank">Ver pagina</a>
    </div>
    <div class="card-body">
...
<script src="<?= base_url('assets/js/cliente-perfil.js') ?>?v=<?= config('App')->assetVersion ?>"></script>
<?= $this->endSection() ?>